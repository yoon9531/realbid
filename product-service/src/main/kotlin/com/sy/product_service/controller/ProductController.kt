...
class ProductController(
     ...
     */
    @PostMapping
    fun createProduct(@Valid @RequestBody createRequest: ProductCreateRequest): ResponseEntity<ProductResponse> {
        // TODO: 실제로는 Spring Security의 Authentication 객체에서 사용자 ID를 가져와야 합니다.
